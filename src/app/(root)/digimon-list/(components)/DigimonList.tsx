  ...
  return (
    <main className="w-3/4 p-4">
      <div className="flex justify-between">
        <Link href={`/digimon-list/${handleIdChange(-1)}`}>Anterior</Link>
        <Link href={`/digimon-list/${handleIdChange(+1)}`}>Proximo</Link>
      </div>
      <h1 className="ml-6 mt-20 text-3xl font-bold uppercase">
        List de Digimons
      </h1>
