...
const DigimonItem = async ({ id }: { id: string }) => {
  ...
  return (
    <div className="flex flex-col p-2">
      ...
      <h2 className="text-center text-xl font-bold">Levels</h2>
      ...
      <h2 className="text-center text-xl font-bold">Types</h2>
      ...
      <h2 className="text-center text-xl font-bold">Attributes</h2>
      ...
      <h2 className="text-center text-xl font-bold">Prior Evolutions</h2>
      <div className="flex flex-wrap">
        {digimonData.priorEvolutions.map((pEvolutions) => (
          <div
            key={pEvolutions.id}
            className="flex flex-1 basis-auto flex-col p-5 text-center"
          >
            {pEvolutions.id}
            <Image
              className="m-auto"
              src={pEvolutions.image}
              alt={digimonData.name}
              width={100}
              height={50}
            />
      ...
      <h2 className="text-center text-xl font-bold">Next Evolutions</h2>
      <div className="flex flex-wrap">
